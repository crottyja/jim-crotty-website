            ...
            <div className="space-y-4">
              ...
              {[
                ...
                },
                {
                  ...
                  logo: "https://d2xsxph8kpxj0f.cloudfront.net/310519663451950503/iBHV5ZcZsrLaWgHahkPnfq/univ-logo-auburn-mark_30a1a3fc.png",
                ...
                <div key={ed.school} className="flex items-start gap-3">
                  ...
                  >
                    <img
                      ...
                      loading="lazy"
                      style={{
                        width: (ed as any).logoSize ? `${(ed as any).logoSize}px` : "44px",
                        height: (ed as any).logoSize ? `${(ed as any).logoSize}px` : "44px",
                        objectFit: "contain",
                      }}
                    />
                  </a>
